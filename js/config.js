...
export const STAGES = [
    ...
    },
    {
        ...
        victoryLines: [
            "믿을 수 없어요. 당신, 꽤 하네요?",
            "처음으로 제가 졌어요. 기분이 묘하네요.",
            "...한 번만 더 해요. 이대로 끝낼 수 없잖아요.",
        ]
    },
    {
        id: 3,
    ...
    },
    {
        ...
        victoryLines: [
            "살아남았군요. 정말 대단해요.",
            "이 판에서 저를 꺾다니... 오래 기억할게요.",
            "당신 같은 사람은 처음이에요. 진심으로.",
        ]
    },
    {
        id: 7,
        ...
        victoryLines: [
            "...인정합니다. 이 자리에서 저를 이기다니.",
            "당신은... 보통이 아니에요. 진심으로.",
            "오랜만에 느껴보는 패배감이에요. 나쁘지 않군요.",
        ]
    },
    {
        id: 8,
        ...
        victoryLines: [
            "팔도를 넘어 여기서 나를 이기다니. 당신은... 전설이에요.",
            "처음이에요. 봉황이 고개를 숙이는 건.",
            "이 땅 끝에서 승자가 되었군요. 이름을 남겨요.",
        ]
    }
];
...
export const ROULETTE_ITEMS = [
    ...
    { name: "8만냥 횡재!", effect: { type: "boardMoney", value: 80000 } },
    { name: "4만냥 몰수", effect: { type: "boardMoneyLoss", value: 40000 } },
];

export const SHOWTIME_REPLAY_COST  =  30000; // 쇼타임 재관람 비용

// 점당 금액 레벨 테이블 — 돈을 지불해 영구 업그레이드
export const MONEY_PER_POINT_LEVELS = [
    { level: 1, value:    1000, cost:         0, label: '하수'   },
    { level: 2, value:    3000, cost:    50000,  label: '중수'   },
    { level: 3, value:   10000, cost:   200000,  label: '고수'   },
    { level: 4, value:   30000, cost:   800000,  label: '명인'   },
    { level: 5, value:  100000, cost:  3000000,  label: '전설'   },
];
